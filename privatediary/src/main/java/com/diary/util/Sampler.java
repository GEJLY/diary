...
public class Sampler
{
	...
	// 接口帐号
	private static final String account = "1001@501385030001";
	
	// 接口密钥
	private static final String authkey = "6FFF44712CD0614E80E4E38787307909";
	...
	public static void main(String[] args) throws Exception
	{
		...
		*/
		...
		List<SendResultBean> listItem = sendOnce("13676039810", "Java接口测试内容");
